...
@if (Auth::check())
    <div class="pt-15 w-4/5 m-auto">
        <a 
            href="/blog/create"
            class="bg-blue-500 uppercase bg-transparent text-gray-100 text-xs font-extrabold py-2 px-4 rounded">
            Create post
        </a>
    </div>
@endif
...
@foreach ($posts as $post)
    <div class="sm:grid grid-cols-2 gap-20 w-4/5 mx-auto py-15 border-b border-gray-200">
        ...
        <div>
            <h2 class="text-gray-700 text-4xl pb-4">
                {{ $post->title }}
            </h2>
            ...
            <a href="/blog/{{ $post->slug }}" class="uppercase bg-blue-500 text-gray-100 text-lg py-4 px-8 rounded">
                Keep Reading
            </a>
