    ...
    <div class="w-4/5 m-auto">
        <ul>
            @foreach ($errors->all() as $error)
                <li class="w-1/5 mb-4 text-gray-50 bg-red-700 rounded px-4 py-4">
                    {{ $error }}
                </li>
            @endforeach
        </ul>
...
<div class="w-4/5 m-auto">
    <form action="/blog" method="POST" enctype="multipart/form-data">
        ...
        <button type="submit" class="uppercase mt-15 bg-blue-500 text-gray-100 text-lg font-extrabold py-4 px-8 rounded">
            Submit Post
        </button>
    </form>
</div>
